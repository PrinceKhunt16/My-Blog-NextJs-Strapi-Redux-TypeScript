    ...
    return (
        <div className="account flex items-center justify-center">
            <div className="relative w-80 h-96 p-8 rounded-lg bg-[#53bd9530]">
                ...
                <h1 className="pt-4 font-caveatbrush text-2xl text-center text-gray-600">{data.userData.username}</h1>
                <h2 className="pt-1 font-caveatbrush text-2xl text-center text-gray-600">{data.userData.email}</h2>
